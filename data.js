...
const TRIPS = [{
  ...
  days: [
    ...
    },
    {
      ...
      weather: '26°C · Clear 5–11 AM · Rain likely 2–6 PM',
      weatherClass: 'mixed',
      rainPlan: '5:30–11 AM is your safest outdoor window — all key activities are in this slot. Sagano Train (on the way back) is open-air: light rain is atmospheric, heavy rain wear poncho. 2 PM hotel rest is perfectly timed to wait it out. K36 rooftop access is weather-dependent — closed if raining, no refunds. Evening shopping is all indoors.',
      items: [
        ...
        { id: 'd2i3', time: '5:45–7:30 AM', label: 'Fushimi Inari golden hour', note: 'Senbon Torii tunnels, completely empty, no climbing needed', price: 'Free', tag: 'activity' },
        { id: 'd2i5', time: '~7:30 AM', label: 'Street food stalls near Inari entrance', note: 'Inari sushi or taiyaki', price: '~¥400–600 for 2', tag: 'food' },
        { id: 'd2i6', time: '~7:45 AM', label: 'JR to Kyoto Station, then straight to Arashiyama', note: 'JR Nara Line, subway to Shijo-Omiya, Randen Tram to Arashiyama — no hotel stop', price: '¥980 for 2', tag: 'transport' },
        ...
        { id: 'd2i13a', time: '~11:00 AM', label: 'JR Sagano Line to Umahori Station (normal train, not the Romantic Train)', note: '~25–30 min, tap ICOCA; regular JR train, cheaper than the scenic train', price: '¥640 for 2', tag: 'transport' },
        { id: 'd2i13b', time: '~11:30 AM', label: 'Walk to Torokko Kameoka area (~5 min from Umahori)', note: 'Gateway town for the scenic train', price: '—', tag: 'transport' },
        { id: 'd2i15', time: '~11:35 AM–1:15 PM', label: 'Short walk + lunch in Kameoka', note: 'Riverside walk near station; lunch at a local restaurant', price: '¥1,600–3,000 for 2', tag: 'food' },
        { id: 'd2i14', time: '1:30 PM', label: 'Sagano Romantic Train back to Arashiyama/Saga', note: '25 min gorge scenery on the way back; BOOK IN ADVANCE on Klook; the scenic leg, now on the return', price: '¥1,760 for 2', tag: 'transport' },
        { id: 'd2i16', time: '~2:00 PM', label: 'JR Sagano Line back to Kyoto Station', note: '~30 min, rain likely starting around now', price: '¥480 for 2', tag: 'transport' },
        { id: 'd2i17', time: '~2:45 PM', label: 'Back at hotel — REST', note: 'Wait out the afternoon rain, freshen up before K36', price: '—', tag: 'tip' },
        { id: 'd2i18', time: '4:00–4:45 PM', label: 'Vintage bag shopping, Shijo area', note: '2nd Street, Brand Off, Kindal Kyoto Shijo, Ragtag — within 10 min walk; passport for tax-free over ¥5,000', price: 'Budget ~¥5,000 for 1 bag', tag: 'shopping' },
        { id: 'd2i19', time: '~4:45 PM', label: 'Mina Kyoto Mall — GU + Uniqlo + Loft (quick browse)', note: '10 min walk on Kawaramachi, same area as vintage shops', price: 'Budget as needed', tag: 'shopping' },
        { id: 'd2i19b', time: '~5:00 PM', label: 'Head to Higashiyama/Kiyomizu area for K36', note: 'Separate trip from your route today — taxi or bus from Shijo, ~20–25 min', price: '~¥1,000–1,500 taxi or bus for 2', tag: 'transport' },
        { id: 'd2i20', time: '~5:30–7:00 PM', label: 'K36 The Bar & Rooftop — sunset drinks + snack', note: 'Hotel Seiryu Kyoto Kiyomizu, 4F; 360° view with Yasaka Pagoda; arrive 5 PM to avoid the sunset crowd; brother can have a mocktail/soft drink, ask staff; weather-dependent, closes if raining', price: '~¥9,100 for 2', tag: 'food' }
      ]
    },
    {
      id: 'd3',
